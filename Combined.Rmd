...
knn_model3 <-train(fracture ~ age+weight+height+bmi+
                    ...
                    tuneLength=15,
                             metric="logLoss")
classifications = knn(dftrain[,c(5,7,14,19:27)],dftest[,c(5,7,14,19:27)],dftrain$fracture, 
                      prob = TRUE, k = 15)
table(classifications,dftest$fracture)
confusionMatrix(table(classifications,dftest$fracture), positive = "Yes")
...
```{r}
fitControl<-trainControl(method="repeatedcv",number=10,repeats=1,classProbs=TRUE, summaryFunction=mnLogLoss)
knn_model <-train(fracture ~ age+height+fracscore+priorfrac_num+premeno_num+
                    momfrac_num+armassist_num+smoke_num+bonemed_num+
                    bonemed_fu_num+bonetreat_num+raterisk_num,
                           data=dftrain,
                    method="knn",
...
plot(knn1.roc, col = "blue", print.thres="best",lwd = 2, main = "ROC Curves Comparison")
cat("KNN AUROC\n")
auc(knn1.roc)
...
plot(knn2.roc, col = "blue", print.thres="best",lwd = 2, main = "ROC Curves Comparison")
cat("KNN AUROC\n")
auc(knn2.roc)
...
plot(knn3.roc, col = "blue", print.thres="best",lwd = 2, main = "ROC Curves Comparison")
cat("KNN AUROC\n")
auc(knn3.roc)
...
plot(knn4.roc, col = "blue", print.thres="best",lwd = 2, main = "ROC Curves Comparison")
cat("KNN AUROC\n")
auc(knn4.roc)

# All 4 Models
plot(knn1.roc, col = "red", print.thres="best",lwd = 2, main = "ROC Curves Comparison")
lines(knn2.roc, col = "blue", lwd = 2)
lines(knn3.roc, col = "green", lwd = 2)
lines(knn4.roc, col = "purple", lwd = 2)
legend("bottomright", legend = c("K=3, Cont. Var", "K=15, Cont. Var","K=15, All variables","K=15, Custom Complex Model"), col = c("red", "blue","green","purple"), lwd = 2)
```
